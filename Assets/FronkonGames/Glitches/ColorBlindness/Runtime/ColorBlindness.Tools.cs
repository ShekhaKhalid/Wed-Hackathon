...
namespace FronkonGames.Glitches.ColorBlindness
{
  ...
  {
    private static ColorBlindness renderFeature;
    ...
    public static void AddRenderFeature()
    {
      if (IsInRenderFeatures() == false)
      {
        ...
        if (pipelineAsset != null)
        {
          ...
          renderFeature = (ColorBlindness)CreateInstance(typeof(ColorBlindness).ToString());
      ...
      get
      {
        if (renderFeature == null)
        {
          ...
          if (pipelineAsset != null)
          {
            ...
            {
              if (scriptableRendererData.rendererFeatures[i] is ColorBlindness)
                renderFeature = scriptableRendererData.rendererFeatures[i] as ColorBlindness;
            }
          }
        }
